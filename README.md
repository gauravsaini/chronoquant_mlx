...
## Experiment 7: Heterogeneous Layer-wise Compression
**Branch:** `heterogeneous-layers`

**Concept:** Based on expert review, we implemented Layer-Specific strategies. Early transformer layers handle syntax and are highly redundant, while late layers handle deep semantic routing. We combined our branches to assign **2-bit P-frames** (with motion vectors) to the first 50% of layers, and **4-bit P-frames** (with motion vectors) to the last 50% of layers.
